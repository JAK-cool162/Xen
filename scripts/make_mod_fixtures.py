...
REQUESTS = ["Xen, get some wood", "xen follow me", "do you have wood?", "can you get me 5 logs", "stop following me",
            ...
            "xen build a house", "build us a cozy cottage", "build a modern house", "build a house on stilts", "xen build a tower", "make a skyscraper", "dig an underground base", "make a base", "build a hut",
            "build a shelter", "สร้างบ้าน", "any diamonds?", "xen can you get some wood?", "could you follow me?", "what are you doing?", "is it night?",
