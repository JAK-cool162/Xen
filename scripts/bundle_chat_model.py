"""Make the all-in-one mod jar: the mod with its chat model inside.
    ...
    python scripts/bundle_chat_model.py dist/xen-companion-0.4.1-alpha+mc1.21.11.jar smollm2-360m-instruct-q8_0.gguf

writes dist/xen-companion-0.4.1-alpha+mc1.21.11-with-chat.jar: every entry of the mod jar as it is, plus the model at
